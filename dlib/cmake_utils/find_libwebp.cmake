...
if(NOT WEBP_INCLUDE_DIR)
    ...
    MARK_AS_ADVANCED(WEBPMUX_LIBRARY)

    FIND_LIBRARY(WEBPDEMUX_LIBRARY NAMES webpdemux)
    MARK_AS_ADVANCED(WEBPDEMUX_LIBRARY)

    # handle the QUIETLY and REQUIRED arguments and set WEBP_FOUND to TRUE if
    # all listed variables are TRUE
    INCLUDE(${CMAKE_ROOT}/Modules/FindPackageHandleStandardArgs.cmake)
    FIND_PACKAGE_HANDLE_STANDARD_ARGS(WebP DEFAULT_MSG WEBP_LIBRARY WEBP_INCLUDE_DIR WEBPMUX_LIBRARY WEBPDEMUX_LIBRARY)

    SET(WEBP_LIBRARIES ${WEBP_LIBRARY} ${WEBP_LIBRARY} ${WEBPDEMUX_LIBRARY})
